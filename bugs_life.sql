...
--
-- Host: localhost
-- Generation Time: Jun 02, 2021 at 08:04 AM
...
(1, 1, 1, 'Please find below links to the two .pbix files I\'ve created in an attempt toconquer this error I\'m receiving.', '2019-08-07 23:44:00', 'liew'),
(1, 1, 2, 'Try this https://www.dropbox.com/home?preview=Relationships.pbix\n\nJust I removed the relationship between sheet1 and sheet1BridgingTable, sheet2 and sheet2BrdgingTable', '2019-08-07 23:44:00', 'ang'),
(1, 2, 1, 'I am having the same issue with a disc of photos from Christmas given to me by my sister. I have tried opening all of the photos with all of my available opening options and still get the same message as above poster. ', '2019-08-08 23:44:00', 'liew'),
(1, 2, 2, 'lad photos of windows 8 & 10 are worst possible application ever developed!\n\n                    just change default view to \"windows photo viewer\" if you dont have any other application', '2019-08-08 23:44:00', 'btan'),
(1, 2, 3, 'Window 10 can but window vista does not work', '2019-08-08 23:44:00', 'ang'),
(2, 1, 1, 'Here is what I am referring to: https://streamable.com/hkyg3 Apologies for not posting a video when creating the issue! ', '2019-10-01 17:00:00', 'liew'),
(2, 1, 2, 'Thanks for video, seems interesting, weirdly enough I couldn\'t reproduce.\nWill see what can be done.', '2019-10-01 17:00:00', 'ang'),
(2, 1, 3, 'Thanks for everything', '2019-10-01 17:00:00', 'jhoe'),
(2, 2, 1, 'Still a problem. ', '2019-10-08 12:00:00', 'btan'),
(2, 2, 2, '/cc @clarkdo', '2019-10-08 12:00:00', 'ang'),
(3, 1, 1, 'To: https://streamable.com/hkyg3 Apologies for not posting a video when creating the issue!', '2019-09-01 20:00:00', 'liew'),
(3, 1, 2, 'Thanks for video, seems interesting, weirdly enough I couldn\'t reproduce.\nWill see what can be done.', '2019-09-01 20:00:00', 'ang');
...
CREATE TABLE `issues` (
  ...
  `descriptionText` varchar(19000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `createdBy` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
  `assignee` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
  `issue_timestamp` timestamp NULL DEFAULT NULL,
...
(1, 'Nuxtjs', '2019-08-07 23:44:00'),
(2, 'Vuejs', '2019-08-07 23:44:00'),
(3, 'Reactjs', '2019-08-07 23:44:00');
...
CREATE TABLE `react` (
  ...
  `issue_id` int(11) NOT NULL,
  `comment_id` int(11) NOT NULL,
  `reaction` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `users` (`userid`, `username`, `password`, `admin`, `url`, `email`) VALUES
(1, 'jhoe', '5e884898da28047151d0e56f8dc6292773603d0d6aabbdd62a11ef721d1542d8', 0, NULL, NULL),
(2, 'btan', '5e884898da28047151d0e56f8dc6292773603d0d6aabbdd62a11ef721d1542d8', 0, NULL, NULL),
(3, 'liew', '5e884898da28047151d0e56f8dc6292773603d0d6aabbdd62a11ef721d1542d8', 0, NULL, NULL),
(4, 'ang', '5e884898da28047151d0e56f8dc6292773603d0d6aabbdd62a11ef721d1542d8', 0, NULL, NULL);
